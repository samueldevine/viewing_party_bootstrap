...
RSpec.describe "Movie" do
  it 'exists' do
    movie = Movie.new(id: 1, title: "Inception", genres: "Thriller", overview: "Dream inside a dream", vote_count: 1, vote_average: 10, runtime: 243, poster_path: "https://www.linkedin.com/in/christian-valesares/")
